...
SHAPENET_PATH = '/home/peterwg/dataset/ShapeNetCore.v2'#"/home/peterwg/dataset/ShapeNetCore.v2"
...
class ShapeNetCore(ShapeNetBase):  # pragma: no cover
    ...
    def __init__(
        ...
        #dict_file = "/home/peterwg/pytorch3d/pytorch3d/datasets/shapenet/shapenet_synset_dict_v%d.json" % version
        with open('/home/peterwg/local/miniconda3/envs/pytorch3d/lib/python3.9/site-packages/pytorch3d/datasets/shapenet/shapenet_synset_dict_v2.json', "r") as read_dict:
        ...
        self.to_label_dict = {}
        for i, item in enumerate(synsets):
            self.to_label_dict[item] = i
        ...
        for synset in synset_set:
            ...
            model_list = os.listdir(path.join(data_dir, synset))
            '''model_list.sort()
            if phase == "train":
                model_list = model_list[:800]
            else:
                model_list = model_list[800:min(len(model_list), 1000)]'''
